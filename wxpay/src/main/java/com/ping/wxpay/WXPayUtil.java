...
public class WXPayUtil {
    ...
    /**
     * 生成签名. 微信签名方式，SHA1，MD5
     * @Title: generateJsSdkSignature 
     * @Description: 
     * @param data 待签名数据
     * @param signType 签名方式
     * @return 签名
     * @throws Exception
     */
    public static String generateJsSdkSignature(final Map<String, String> data,SignType signType) throws Exception {
        Set<String> keySet = data.keySet();
        String[] keyArray = keySet.toArray(new String[keySet.size()]);
        Arrays.sort(keyArray);
        StringBuilder sb = new StringBuilder();
