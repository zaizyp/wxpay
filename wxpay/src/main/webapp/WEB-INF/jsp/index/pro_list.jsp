...
<div class="weui-content" style="padding-top:85px;">
  ...
  <div id="list" class='demos-content-padded proListWrap'>
		<c:forEach items="${itemList}" var="item">
		  <div class="pro-items">
		    <a href="${pageContext.request.contextPath}/item/${item.id}" class="weui-media-box weui-media-box_appmsg">
		      <div class="weui-media-box__hd"><img class="weui-media-box__thumb" src="${pageContext.request.contextPath}${(fn:split(item.image,','))[0]}" alt=""></div>
		      <div class="weui-media-box__bd">
		        <h1 class="weui-media-box__desc">${item.title}</h1>
		        <div class="wy-pro-pri">¥<em class="num font-15">${item.lowPrice / 100}</em></div>
