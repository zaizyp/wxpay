  ...
  <div class="weui-tab">
    ...
    <div class="weui-tab__bd proinfo-tab-con" style="padding-top:87px;">
      <div id="tab1" class="weui-tab__bd-item weui-tab__bd-item--active">
        <c:forEach items="${orders}" var="orderVo">
          <div class="weui-panel weui-panel_access">
            <div class="weui-panel__hd">
              <span>单号：${orderVO.order.orderId}</span>
              <span class="ord-status-txt-ts fr">交易成功</span></div>
            <div class="weui-media-box__bd  pd-10">
              <c:forEach items="${orderVo.orderItemList}" var="item">
                <div class="weui-media-box_appmsg ord-pro-list">
                  <div class="weui-media-box__hd">
                    <a href="${pageContext.request.contextPath}/item/${item.itemId}">
                      <img class="weui-media-box__thumb" src="${pageContext.request.contextPath}${item.picPath}" alt="">
                    </a>
                  </div>
                  <div class="weui-media-box__bd">
                    <h1 class="weui-media-box__desc">
                      <a href="pro_info.html" class="ord-pro-link">${item.title}</a></h1>
                    <p class="weui-media-box__desc">规格：<span>红色</span>，<span>23</span></p>
                    <div class="clear mg-t-10">
                      <div class="wy-pro-pri fl">¥<em class="num font-15">${item.totalFee}</em></div>
